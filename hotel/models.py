...
class Hotel(models.Model):
    ...
    name=models.CharField(max_length=100, default="Daniel")
    description=CKEditor5Field(null=True, blank=True, config_name="extends")
    image=models.FileField(upload_to="hotel_gallery", default="static/img/about-1.jpg")
    address=models.CharField(max_length=200 , default="111, 30108 Nairobi Kenya")
    mobile=models.CharField(max_length=200, default="0742580239")
    email=models.EmailField(max_length=100, default="ngumodaniel80@gmail.com")
    status=models.CharField(max_length=20, choices=HOTEL_STATUS, default="Live")

    tags=models.CharField(max_length=200, help_text="Separate tags with comma",default="Timboroa")
    views=models.IntegerField(default=0), 
    featured=models.BooleanField(default=False)
    hid=ShortUUIDField(unique=True, length=10, max_length=20, alphabet="abcdefjhijklmnopqrstuvwxyz")
...
class HotelGallery(models.Model):
    ...
    image=models.FileField(upload_to="hotel_gallery", default="static/img/about-1.jpg")
    hgid=ShortUUIDField(unique=True, length=10, max_length=20, alphabet="abcdefjhijklmnopqrstuvwxyz")
...
class RoomType(models.Model):
    ...
    rtid=ShortUUIDField(unique=True, length=10, max_length=20, alphabet="abcdefjhijklmnopqrstuvwxyz")
    slug=models.SlugField(unique=True)
    date=models.DateTimeField(auto_now_add=True)
...
class Room(models.Model):
    ...
    rid=ShortUUIDField(unique=True, length=10, max_length=20, alphabet="abcdefjhijklmnopqrstuvwxyz")
    date=models.DateTimeField(auto_now_add=True)
...
class Booking(models.Model):
    ...
    booking_id=ShortUUIDField(unique=True, length=10, max_length=20, alphabet="abcdefjhijklmnopqrstuvwxyz")
