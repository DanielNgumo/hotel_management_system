...
# a function for storing uploaded images from the user organised
...
class Profile(models.Model):
    pid=ShortUUIDField(length=7, max_length=25, alphabet="abcdefghijkrmnopqrstuvwyz123")
    ...
    finallyacebook=models.URLField( null=True, blank=True)
